$(function(){
    ...
    $('.main-slide').on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
        
        var i = (currentSlide ? currentSlide : 0) + 1;
        $(".count").text(i +"/"+slick.slideCount);
    });
    $('#section01 .xi-long-arrow-left').on("click",function(){
        $('.main-slide').slick('slickPrev');
	});
    $('#section01 .xi-long-arrow-right').on("click",function(){
